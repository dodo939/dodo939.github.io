...
tags:
  ...
  - QQ机器人
  - AI
index_img: https://dodo939.oss-cn-beijing.aliyuncs.com/blog/2024/bot-help-0.jpg
banner_img: https://dodo939.oss-cn-beijing.aliyuncs.com/blog/2024/bot-help-0.jpg
---
...
连接你的 Minecraft Java 版服务器，并执行命令（需要先使用 `mcrcon.bind` 绑定），返回结果。参数格式为 `mcrcon <command>`

使用示例: `mcrcon whitelist add dodo939`

#### mcrcon.bind

> ⚠ 警告：请在私聊中使用，避免透露敏感信息。机器人主承诺不会泄露任何信息，如不信任，请不要使用 mcrcon 相关功能。

绑定 Minecraft Java 版服务器，之后才可以使用 `mcrcon` 执行命令，参数格式为 `mcrcon.bind <ip> <password> <port>`

使用示例: `mcrcon.bind 127.0.0.1 12345678 25575`
